export const servicesData = {
  ...
  "tracheostomy-care": {
    ...
    subtitle: "Expert trach care with calm confidence",
    description: "Expert trach care and suctioning from nurses who've done this hundreds of times—but who also remember how terrifying it was the first time they did it. We'll teach you, support you, and be there when you need backup.",
    whatWeProvide: [
    ...
    ctaTitle: "Need Expert Tracheostomy Support?",
    ctaDescription: "Our experienced nurses provide confident trach care and round-the-clock backup.",
    ctaButton: "Get Trach Care Support"
  },
  ...
  "ventilator-respiratory": {
    ...
    whatWeProvide: [
      ...
      "Quick response to respiratory changes"
    ],
  ...
  "gtube-feeding": {
    ...
    whatWeProvide: [
      ...
      "Reflux and complication management"
    ],
    realTalk: "Feeding issues are stressful. Whether it's reflux, retching, or equipment problems, we've seen it all and we know how to troubleshoot. Plus, we'll clean up without making you feel bad about the mess.",
    keyBenefits: [
      "Expert feeding troubleshooting",
      "Nutritional monitoring",
      "Non-judgmental approach",
      "Equipment problem-solving"
    ],
    summary: "We've seen it all and know how to troubleshoot—and we'll clean up without judgment.",
    ctaTitle: "Struggling With Feeding Issues?",
    ctaDescription: "Our nurses are skilled in G-tube management and feeding troubleshooting.",
    ctaButton: "Get Feeding Support"
  },

  "wound-ostomy": {
    id: "wound-ostomy",
    title: "Wound Care & Ostomy Management",
    subtitle: "Healing with expertise and gentleness",
    description: "Pressure wound care, surgical site care, and ostomy management. We use evidence-based techniques to promote healing while minimizing discomfort.",
    whatWeProvide: [
      "Pressure wound prevention and care",
    ...
    keyBenefits: [
      ...
      "Trust-building care methods"
    ],
    summary: "We go slow, explain what we're doing, and never force anything—trust is earned.",
    ctaTitle: "Need Gentle Wound Care?",
    ctaDescription: "Our nurses provide evidence-based wound care with a trauma-informed approach.",
    ctaButton: "Learn About Wound Care"
  },
  ...
  "seizure-management": {
    ...
    summary: "Our nurses stay calm, follow your plan, and document everything for your neurologist.",
    ctaTitle: "Worried About Seizure Safety?",
    ctaDescription: "Trust our trained nurses to monitor and respond to seizure activity.",
    ctaButton: "Discuss Seizure Care"
  },
  ...
  "skilled-nursing": {
    ...
    summary: "If you have that gut feeling something's off, we trust it—and we'll investigate.",
    ctaTitle: "Need Clinical Oversight?",
    ctaDescription: "Our skilled nurses provide expert monitoring and coordinate with your medical team.",
    ctaButton: "Get Skilled Nursing"
  },
...
export const servicesList = [
  { id: "personal-care", name: "Personal Care & Daily Living Support", shortName: "Personal Care" },
  { id: "mobility-positioning", name: "Mobility & Positioning Assistance", shortName: "Mobility Support" },
  { id: "medication-administration", name: "Medication Administration", shortName: "Medications" },
  { id: "tracheostomy-care", name: "Tracheostomy Care", shortName: "Trach Care" },
  { id: "ventilator-respiratory", name: "Ventilator & Respiratory Support", shortName: "Respiratory" },
  { id: "gtube-feeding", name: "G-Tube & Feeding Support", shortName: "Feeding" },
  { id: "wound-ostomy", name: "Wound Care & Ostomy Management", shortName: "Wound Care" },
  { id: "seizure-management", name: "Seizure Management & Monitoring", shortName: "Seizure Care" },
  { id: "skilled-nursing", name: "Skilled Nursing Assessments", shortName: "Skilled Nursing" },
  { id: "family-training", name: "Family Training & Support", shortName: "Family Training" }
];
