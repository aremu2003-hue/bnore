...
function Header() {
  ...
  const resources = [
    ...
    { name: 'State resources', href: '/resources/state' },
    { name: 'Federal resources', href: '/resources/federal' }
  ];
      ...
      <div className="header-container">
        ...
        <nav className="nav desktop-nav" data-aos="fade-down" data-aos-delay="200">
          <ul className="nav-list">
            ...
            <li><Link to="/insurance" className="nav-link">{homeCopy.header.navigation.insurance}</Link></li>
            <li
              className="nav-item dropdown"
        ...
        {/* <div className="social-media-links desktop-social" data-aos="fade-down" data-aos-delay="250">
          <a
            href="https://www.facebook.com/profile.php?id=61585665866697&sk=about"
            target="_blank"
        ...
        {/* Desktop CTA Buttons */}
        <div className="cta-buttons1 desktop-cta" data-aos="fade-left" data-aos-delay="300">
          {/* <ThemeToggle /> */}
          <Link to="/contact">
      ...
      <div className={`mobile-nav ${isMobileMenuOpen ? 'active' : ''}`}>
        <div className="mobile-nav-content">
          <ul className="mobile-nav-list">
            ...
            <li>
              <Link to="/conditions" className="mobile-nav-link" onClick={closeMobileMenu}>
                {homeCopy.header.navigation.conditions}
              </Link>
            </li>
            <li>
              <Link to="/insurance" className="mobile-nav-link" onClick={closeMobileMenu}>
                {homeCopy.header.navigation.insurance}
              </Link>
            </li>
            <li className="mobile-dropdown">
              <button
              ...
              <div className={`mobile-dropdown-menu ${isResourcesOpen ? 'show' : ''}`}>
                {resources.map((resource, index) => (
                  <Link
                    key={index}
                    to={resource.href}
