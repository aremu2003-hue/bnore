...
const Admin_Phone = process.env.ADMIN_PHONE || '713 370 2755'; // Default fallback
...
function getUrgencyColor(urgency) {
    ...
    return colorMap[urgency] || '#809f3b';
}
                    ...
                    <tr>
                        <td style="background-color: #f8f9fa; padding: 30px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 20px; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e9ecef;">
                                <tr>
                                    <td style="font-weight: bold; color: #ffffff; background-color: #8e211b; padding: 12px 15px; margin: 0; font-size: 14px; font-family: Arial, sans-serif;">👤 Full Name</td>
                                </tr>
                                <tr>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 20px; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e9ecef;">
                                <tr>
                                    <td style="font-weight: bold; color: #ffffff; background-color: #8e211b; padding: 12px 15px; margin: 0; font-size: 14px; font-family: Arial, sans-serif;">📧 Email Address</td>
                                </tr>
                                <tr>
                                    <td style="padding: 15px; margin: 0; background-color: #ffffff; font-size: 16px; line-height: 1.5; font-family: Arial, sans-serif;">
                                        <a href="mailto:${formData.email}" style="color: #8e211b; text-decoration: none; font-weight: 500;">${formData.email || 'Not provided'}</a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 20px; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e9ecef;">
                                <tr>
                                    <td style="font-weight: bold; color: #ffffff; background-color: #8e211b; padding: 12px 15px; margin: 0; font-size: 14px; font-family: Arial, sans-serif;">📞 Phone Number</td>
                                </tr>
                                <tr>
                                    <td style="padding: 15px; margin: 0; background-color: #ffffff; font-size: 16px; line-height: 1.5; font-family: Arial, sans-serif;">
                                        <a href="tel:${formData.phone}" style="color: #8e211b; text-decoration: none; font-weight: 500;">${formData.phone || 'Not provided'}</a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 20px; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e9ecef;">
                                <tr>
                                    <td style="font-weight: bold; color: #ffffff; background-color: #8e211b; padding: 12px 15px; margin: 0; font-size: 14px; font-family: Arial, sans-serif;">🏥 Service of Interest</td>
                                </tr>
                                <tr>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 20px; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e9ecef;">
                                <tr>
                                    <td style="font-weight: bold; color: #ffffff; background-color: #8e211b; padding: 12px 15px; margin: 0; font-size: 14px; font-family: Arial, sans-serif;">💬 Message</td>
                                </tr>
                                <tr>
                                    <td style="padding: 15px; margin: 0; background-color: #ffffff; font-size: 16px; line-height: 1.5; font-family: Arial, sans-serif;">
...
<head>
    ...
    <style type="text/css">
        ...
        .header { background-color: #8e211b; padding: 40px 30px; text-align: center; }
        ...
        .thank-you-title { color: #8e211b; font-size: 24px; font-weight: bold; margin: 0 0 15px 0; }
        .thank-you-text { color: #666666; font-size: 16px; line-height: 24px; margin: 0; }
        .info-box { background-color: #f8f9fa; border-left: 4px solid #8e211b; padding: 20px; margin: 30px 0; }
        ...
        .footer { background-color: #8e211b; padding: 30px; text-align: center; }
...
<head>
    ...
    <style type="text/css">
        ...
        .content { padding: 40px 30px; background-color: #ffffff; }
        .thank-you-section { text-align: center; margin-bottom: 30px; }
        .consultation-summary { background-color: #f5f7f0; border-left: 4px solid #809f3b; padding: 25px; margin: 30px 0; }
        .footer { background-color: #8e211b; padding: 30px; text-align: center; }
        .footer p { color: #cccccc; font-size: 14px; margin: 5px 0; }
        .footer a { color: #ffffff; text-decoration: none; font-weight: bold; }
    </style>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr><td class="content">
                        <div class="thank-you-section">
                            ...
                            <h2 style="color: #8e211b; font-size: 24px; font-weight: bold;">Thank You for Trusting Us</h2>
...
Name: ${fullName}${formData.preferredName ? ' (Preferred: ' + formData.preferredName + ')' : ''}
Email: ${formData.email || 'Not provided'}
Mobile Phone: ${formData.mobilePhone || 'Not provided'}
${formData.homePhone ? 'Home Phone: ' + formData.homePhone + '\n' : ''}Address: ${formData.address || 'Not provided'}${formData.addressLine2 ? ', ' + formData.addressLine2 : ''}
...
${(formData.educationHighSchool || formData.educationCollege || formData.school) ? `
EDUCATION:
${formData.educationHighSchool || formData.educationCollege ? 'Education Level: ' + (formData.educationHighSchool ? 'High School' : '') + (formData.educationHighSchool && formData.educationCollege ? ', ' : '') + (formData.educationCollege ? 'College' : '') + '\n' : ''}${formData.school ? 'School: ' + formData.school + '\n' : ''}${formData.degreeReceived ? 'Degree: ' + formData.degreeReceived + '\n' : ''}
` : ''}${formData.employers && formData.employers.length > 0 && formData.employers[0].employer ? `
EMPLOYMENT HISTORY:
${formData.employers.map((emp, idx) => emp.employer ? `
Employer ${idx + 1}:
  Employer: ${emp.employer}
  ${emp.supervisor ? 'Supervisor: ' + emp.supervisor + '\n  ' : ''}${emp.phoneNumber ? 'Phone: ' + emp.phoneNumber + '\n  ' : ''}${emp.dateFrom || emp.dateTo ? 'Dates: ' + (emp.dateFrom || '') + ' to ' + (emp.dateTo || 'Present') + '\n  ' : ''}${emp.address1 ? 'Address: ' + emp.address1 + (emp.address2 ? ', ' + emp.address2 : '') + ', ' + (emp.city || '') + ', ' + (emp.state || '') + ' ' + (emp.postalCode || '') + '\n' : ''}
` : '').join('')}
` : ''}${formData.references && formData.references.length > 0 && formData.references[0].name ? `
...
Reference ${idx + 1}:
  Name: ${ref.name}
  ${ref.phoneNumber ? 'Phone: ' + ref.phoneNumber + '\n' : ''}
` : '').join('')}
` : ''}ADDITIONAL INFORMATION:
${formData.availability ? 'Availability: ' + formData.availability + '\n' : ''}${formData.trainingsCertifications ? 'Trainings/Certifications: ' + formData.trainingsCertifications + '\n' : ''}${formData.felonyConviction ? 'Felony Conviction (Last 5 Years): ' + formData.felonyConviction + '\n' : ''}${formData.eligibleForEmployment ? 'Eligible for Employment: ' + formData.eligibleForEmployment + '\n' : ''}${formData.howDidYouHear ? 'How did you hear about us: ' + formData.howDidYouHear + '\n' : ''}${formData.resumeUrl ? 'Resume: ' + formData.resumeUrl + '\n' : ''}${formData.cvUrl ? 'CV: ' + formData.cvUrl + '\n' : ''}
---
${Admin_Name}
${Admin_Phone}
${Admin_Email}
